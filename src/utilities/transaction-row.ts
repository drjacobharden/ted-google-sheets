...
import { escapeHTML } from "./view-formatters";
import { DateUtils } from "./date-utilities";

const currency = new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" });
const shortDateFormatter = DateUtils.shortDateFormatter;

export function createTransactionRow(transaction: BudgetTransaction): HTMLTableRowElement {
