...
export type RouteName = "dashboard" | "budget-overview" | "transactions" | "categories" | "vendors" | "people" | "import" | "entity-detail" | "entity-archive" | "sync" | "settings" | "investment-overview" | "investment-accounts" | "investment-account-detail";
