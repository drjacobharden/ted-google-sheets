...
export function investmentLedgerRows():InvestmentLedgerRow[]{const accounts=APIs.accounts.accounts();return buildInvestmentLedgerRows(accounts,APIs.accounts.activity());}
